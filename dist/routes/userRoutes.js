...
router.get("/all-users", authController.protectRoute, userController.getAllUsers);
router.get("/:id/me", authController.protectRoute, userController.getMe);
router.get("/:id/update-me", authController.protectRoute, userController.updateMe);
